...
const Modals = (($) => {
  ...
  class Modals {
    ...
    _open (object) {
      ...
      } else if (object.hasClass(ClassName.MODAL_BOTTOM_SHEET)) { // Bottom Sheet
      ...
      } else if (object.hasClass(ClassName.MODAL_LEFT_SHEET)) { // Left Sheet
      ...
      } else if (object.hasClass(ClassName.MODAL_RIGHT_SHEET)) { // Right Sheet
